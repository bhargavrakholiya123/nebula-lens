...
function S3Node({ id, data, selected, positionAbsoluteX }: { id: string; data: any; selected?: boolean; positionAbsoluteX?: number }) {
  ...
  return (
    ...
    >
      ...
      <div className="mt-3 space-y-1 text-[12px] font-normal text-[var(--gl-text-muted)]">
        ...
        <div className="flex justify-between items-center bg-slate-100/50 dark:bg-slate-950/50 px-2 py-1 rounded">
          <span className="font-normal text-[var(--gl-text-muted)]">Access:</span>
          <span className="text-amber-600 dark:text-amber-500 font-normal">{data.publicAccess}</span>
        </div>
        <div className="flex justify-between items-center bg-slate-100/50 dark:bg-slate-950/50 px-2 py-1 rounded">
          <span className="font-normal text-[var(--gl-text-muted)]">TotalSize:</span>
          <span className="text-[12px] font-normal text-[var(--gl-text-muted)]">{data.metrics.totalSize}</span>
        </div>
      </div>
